 ...
 */
final class Version20240317113451 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__event AS SELECT id, title, description, date, status, created, updated, user_id, user_group_id FROM event');
        $this->addSql('DROP TABLE event');
        $this->addSql('CREATE TABLE event (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, title VARCHAR(255) NOT NULL, description CLOB DEFAULT NULL, date DATETIME DEFAULT NULL, status BOOLEAN NOT NULL, created DATETIME DEFAULT 0, updated DATETIME DEFAULT 0, user_id INTEGER NOT NULL, user_group_id INTEGER NOT NULL, CONSTRAINT FK_3BAE0AA7A76ED395 FOREIGN KEY (user_id) REFERENCES user (id) ON UPDATE NO ACTION ON DELETE NO ACTION NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_3BAE0AA71ED93D47 FOREIGN KEY (user_group_id) REFERENCES "group" (id) ON UPDATE NO ACTION ON DELETE NO ACTION NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO event (id, title, description, date, status, created, updated, user_id, user_group_id) SELECT id, title, description, date, status, created, updated, user_id, user_group_id FROM __temp__event');
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__group AS SELECT id, created, updated, user_id FROM "group"');
        $this->addSql('DROP TABLE "group"');
        $this->addSql('CREATE TABLE "group" (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, created DATETIME DEFAULT 0, updated DATETIME DEFAULT 0, user_id INTEGER NOT NULL, title VARCHAR(255) NOT NULL, status BOOLEAN NOT NULL, CONSTRAINT FK_6DC044C5A76ED395 FOREIGN KEY (user_id) REFERENCES user (id) ON UPDATE NO ACTION ON DELETE NO ACTION NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO "group" (id, created, updated, user_id) SELECT id, created, updated, user_id FROM __temp__group');
