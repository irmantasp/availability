 ...
 */
final class Version20240317004348 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__availability AS SELECT id, year, month, days FROM availability');
        ...
        $this->addSql('INSERT INTO availability (id, year, month, days) SELECT id, year, month, days FROM __temp__availability');
